  ...
  return (
    <section className="landing-hero">
      <div className="hero-text">
        ...
        <a href="#" className="cta-button" style={{ background: "#203764", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
...
export default IntroSectionPrev;
