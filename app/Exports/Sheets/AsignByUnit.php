...
class AsignByUnit implements FromArray, WithTitle, WithStyles, WithColumnWidths, WithCharts
{
    private array $rows = [];

    public function title(): string
    {
        return 'Asignados por Unidad';
    }
    ...
    public function array(): array
    {
        ...
        $data = [['Unit', 'Tickets abiertos']];
        foreach ($records as $r) {
            $data[] = [$r->unit, (int)$r->total];
        }
    ...
    public function charts(): array
    {
        ...
        $title    = new Title('Tickets abiertos por unidad');

        // Coloca el gráfico a la derecha de la tabla
        $chart = new Chart(
            'chart_asignados_por_unit',
            $title,
            $legend,
            $plotArea,
            true,
